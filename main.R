...
library("affy")
phenodata = read.AnnotatedDataFrame(file='C:\\Users\\Manu\\Desktop\\Studium\\Master\\BSS, Labor\\UE7 - DNA sensors and Microarrays\\GSE41328\\phenodata.txt') 
...
celfiles = ReadAffy(filenames=sampleNames(phenodata),
                    celfile.path='C:\\Users\\Manu\\Desktop\\Studium\\Master\\BSS, Labor\\UE7 - DNA sensors and Microarrays\\GSE41328',
                    phenoData=phenodata)

#Verify it using the class() function.
class(celfiles)

#didn't work..... check later 
celfiles
